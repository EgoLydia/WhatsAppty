                ...
                <div class="
                    ...
                    <div class="flex items-center">
                        ...
                        <div  v-if="userDataForChat[0] && userDataForChat[0].firstName" class="text-gray-900 ml-1 font-semibold">
                            {{ userDataForChat[0].firstName }} {{ userDataForChat[0].lastName }}
                        </div>
                        </div>
                        ...
                        <div id="MessagesSection"
                            ...
                            <div class="w-[calc(100vw-420px)] p-2.5 z-10 bg-[#F0F0F0] fixed bottom-0">
                                <div class="flex items-center justify-center">
                                    ...
                                    <input v-model="message" class="                                                                                                                                                                                                                         shadow
                                                                                                                                                                                                                                                                                                                                                                                        apperance-none
                                                                                                                                                                                                                                                                                                                                                                                        rounded-lg
                                                                                                                                                                                                                                                                                                                                                                                        w-full
                                                                                                                                                                                                                                                                                                                                                                                        py-3
                                    ...
                                    <button :disabled="disableButton" @click="sendMessage" class="ml-3 p-2 w-12 flex items-center justify-center">
