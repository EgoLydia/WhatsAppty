<template>
    <div class=" w-full">
        <div class=" bg-teal-600 z-[-1] w-full h-[225px] fixed top-0">
        </div>
        <div class=" bg-[#191919] z-[-1] w-full h-[calc(100vh-225px)] fixed bottom-0">
        </div>
        ...
        <div class=" max-w-xl mx-auto">
            ...
            <div class=" bg-white z-10 p-24 m-6 mt-10">
                ...
                <div class=" w-full flex justify-center bg-[#191919]">
